...
// let testArr = [...originalFlavors];
// testArr.push("test flavor");
// console.log("testArr has 31 flavors: " + is31Flavors(testArr));
...
console.log(wordFilter(originalFlavors, 'Chocolate'));
